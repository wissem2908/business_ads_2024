...
$.ajax({
    url:'./assets/php/wanted_ads_details.php',
    method:'post',
    async:false,
...
if(data.mobile_number!=''){
    ...
    var options = {
        call: data.mobile_number, // Call phone number
...
/*************************************************************************************** */    $('#user_link').append('<a href="./'+data.username+'">'+host+'/'+data.username+'</a>')
    ...
    function loadImages(){
$.ajax({
    url:'./assets/php/wanted_liste_images.php',
    method:'post',
    async:false,
    data:{ad_id:ad_id},
    success:function(response){
...
if(data.length!=0){
    $('#image_ads_lien').attr('href','./admin/gen_user_ads_images/'+data[0].path)
    $('#ad_image').attr('src','./admin/gen_user_ads_images/'+data[0].path)
    ...
    $('#ad_image').attr('src','../../../admin/logo_images/'+user_logo)
            ...
            for(i=0;i<data.length;i++){
                listImg+='  <a style="margin-right: 10px;" href="./admin/gen_user_ads_images/'+data[i].path+'" class="fancybox mr-2" data-fancybox="gallery1">  <img src="./admin/gen_user_ads_images/'+data[i].path+'"  style="max-width:80px;max-height: 80px;" class="rounded"  ></a>'
            }
