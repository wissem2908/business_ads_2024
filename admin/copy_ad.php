        ...
        <div class="content-body">
            ...
            <div class="container-fluid">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Copy Ad</a></li>
                    </ol>
                </div>
               <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Copy ad</h4>
                                <a href="#" onclick="history.back()" type="button" class="btn btn-outline-primary">Back</a>
                            </div>
                             <form method="post" enctype="multipart/form-data" id="copy_ad">
                            <div class="card-body">
...
<script type="module" src="assets/js/copy_ad.js"></script>
