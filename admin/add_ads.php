                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="ads_list.php" type="button" class="btn btn-outline-primary">List Ads</a>
                            </div>
                             <form method="post" enctype="multipart/form-data" id="add_ad">
                            <div class="card-body">
                               <input type="hidden" id="user_id"  value="<?php echo $user_id;  ?>" name="user_id">
                               <div class="row"><div class="col-lg-12"> <span class="text-danger">*required</span><br/><br/></div></div>
