      ...
      <style>
        ...
        <div class="content-body">
            ...
            <div class="container-fluid">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">General Ads</a></li>
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Edit General Ad</a></li>
                    </ol>
                </div>
               <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Edit General ad</h4>
...
<script type="module" src="assets/js/edit_gen_user_ad.js"></script>
