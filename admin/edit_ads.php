                               ...
                               <input type="hidden" id="ads_id"  value="<?php echo $ads_id;  ?>" name="ads_id">
                                     <div class="row"> 
                                        ...
                                        <label class="form-label">My Category <span class="text-danger required"  >*required</span></label>
                                           <select class="form-control input-default " name="categories" id="categories">
                                            <option></option>
                                           </select>
                                        </div>
                                        ...
                                        <label class="form-label">General Category <span class="text-danger required" >*required</span></label>
                                           <select class="form-control input-default " name="general_cat" id="general_cat">
                                            <option></option>
                                           </select>
                                        </div>
                                        <div class="mb-3 col-lg-6 col-md-12">
                                        <label class="form-label">Sub Category <span class="text-danger required" >*required</span></label>
                                           <select class="form-control input-default " name="sub_categories" id="sub_categories">
                                            <option></option>
                                           </select>
                                        </div>
                                         <div class="mb-3 col-lg-6 col-md-12">
...
"><i> (optional)</i></span> </label>
                                           <select class="form-control input-default " name="city" id="city">
